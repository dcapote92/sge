...
urlpatterns = [
    ...
    path('api/v1/suppliers/', views.SupplierCreateListAPIView.as_view(), name='supplier-create-list-api-v1'),
    path('api/v1/suppliers/<int:pk>/', views.SupplierDetailAPIView.as_view(), name='supplier-detail-list-api-v1')
]
