...
urlpatterns = [
    ...
    path('api/v1/brands/', views.BrandCreateListAPIView.as_view(), name='brand-create-list-api-v1'),
    path('api/v1/brands/<int:pk>/', views.BrandDetailAPIView.as_view(), name='brand-detail-list-api-v1')
]
