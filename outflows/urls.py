...
urlpatterns = [
    ...
    path('api/v1/outflows/', views.OutflowCreateListAPIView.as_view(), name='outflow-create-list-api-v1'),
    path('api/v1/outflows/<int:pk>/', views.OutflowDetailAPIView.as_view(), name='outflow-detail-list-api-v1')
]
