...
urlpatterns = [
    ...
    path('api/v1/inflows/', views.InflowCreateListAPIView.as_view(), name='inflow-create-list-api-v1'),
    path('api/v1/inflows/<int:pk>/', views.InflowDetailAPIView.as_view(), name='inflow-detail-list-api-v1')
]
